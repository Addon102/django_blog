...
class SearchResults(HomeView):
    def get_queryset(self):
        ...
        return Article.objects.filter(Q(title__iregex=query) | Q(short_description__iregex=query))


def get_articles_by_categories(request, category_id):
...
def author_articles(request, username):
    ...
    return render(request, 'core/my_articles.html', context)
